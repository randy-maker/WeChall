...
# [ level 11 ]
## Ce challenge est une deuxième version du niveau 10 mais les instructions pour obtenir le mot de passe reste à quelques détails près les mêmes . Après l'analyse de ce code j'en suis venue à cette solution :
